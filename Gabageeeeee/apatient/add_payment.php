                                      ...
                                      <option selected value="">---Choose---</option>
                                       ...
                                       <option value="percollection" <?php echo $res['pay_type'] == 'percollection' ? 'selected' : '' ?>>Per Collection </option> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                  <input type="text" name="categoty" required  class="form-control" placeholder="Enter the weight of the patient you are registering">
 </div>
                                            </div>
                                        </div>
                                         <div class="row">
...
$query=mysqli_query($con,"insert into clients values($names,$pay_type,$gabage_type,$location,$contact,$status,$category)");
